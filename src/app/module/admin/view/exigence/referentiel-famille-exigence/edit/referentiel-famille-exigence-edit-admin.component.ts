...
@Component({
  selector: 'app-referentiel-famille-exigence-edit-admin',
  templateUrl: './referentiel-famille-exigence-edit-admin.component.html'
})
export class ReferentielFamilleExigenceEditAdminComponent implements OnInit {
