            ...
            [
                {
                    ...
                    children: [
...

                        {
                            ...
                            path: 'referentiel-famille-exigence',
                            children: [
                                {
                                    path: 'list',
                                    component: ReferentielFamilleExigenceListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            path: 'famille-exigence',
                            children: [
                                {
                                    path: 'list',
                                    component: FamilleExigenceListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },

                        {
                            ...
                            children: [
                                {
                                    path: 'list',
                                    component: ExigenceListAdminComponent ,
                                    canActivate: [AuthGuard]
                                }
                            ]
                        },
...
export class ExigenceAdminRoutingModule { }
