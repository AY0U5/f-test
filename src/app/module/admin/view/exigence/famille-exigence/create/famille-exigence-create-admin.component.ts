...
@Component({
  selector: 'app-famille-exigence-create-admin',
  templateUrl: './famille-exigence-create-admin.component.html'
})
export class FamilleExigenceCreateAdminComponent  implements OnInit {
   ...
   private _validFamilleExigenceStyle = true;
    ...
    const isPermistted = await this.roleService.isPermitted('ReferentielFamilleExigence', 'add');
    if(isPermistted) {
