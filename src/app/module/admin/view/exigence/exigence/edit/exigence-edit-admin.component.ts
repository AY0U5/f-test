...
@Component({
  selector: 'app-exigence-edit-admin',
  templateUrl: './exigence-edit-admin.component.html'
})
export class ExigenceEditAdminComponent implements OnInit {
 ...
 public edit(): void {
   ...
   public async openCreateFamilleExigence(familleExigence: string) {
        const isPermistted = await this.roleService.isPermitted('FamilleExigence', 'edit');
        if (isPermistted) {
