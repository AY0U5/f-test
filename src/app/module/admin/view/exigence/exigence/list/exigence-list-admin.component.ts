...
@Component({
  selector: 'app-exigence-list-admin',
  templateUrl: './exigence-list-admin.component.html'
})
export class ExigenceListAdminComponent implements OnInit {

    protected fileName = 'Exigence';
    ...
    familleExigences: Array<FamilleExigenceDto>;
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ExigenceDto>();
    ...
    public async edit(dto: ExigenceDto) {
    ...
    public async view(dto: ExigenceDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ExigenceDto) {
    ...
    public async duplicate(dto: ExigenceDto) {
    ...
    public exportPdf(dto: ExigenceDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'familleExigence?.libelle', header: 'Famille exigence'},
        ];
    }


    public async loadFamilleExigence(){
        this.familleExigenceService.findAllOptimized().subscribe(familleExigences => this.familleExigences = familleExigences, error => console.log(error))
    }


	public initDuplicate(res: ExigenceDto) {
	}
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            (allItems) =>{
                this.exportData = allItems.map(e => {
					return {
						...
						'Famille exigence': e.familleExigence?.libelle ,
					}
				});
            ...
            //'Famille exigence': this.criteria.familleExigence?.libelle ? this.criteria.familleExigence?.libelle : environment.emptyForExport ,
            }];
			}
    ...
    get selections(): Array<ExigenceDto> {
        return this.service.selections;
    }

    set selections(value: Array<ExigenceDto>) {
