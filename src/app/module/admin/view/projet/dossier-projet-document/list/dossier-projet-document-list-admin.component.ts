...
@Component({
  selector: 'app-dossier-projet-document-list-admin',
  templateUrl: './dossier-projet-document-list-admin.component.html'
})
export class DossierProjetDocumentListAdminComponent implements OnInit {

    protected fileName = 'DossierProjetDocument';
    ...
    dossierProjets: Array<DossierProjetDto>;
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<DossierProjetDocumentDto>();
    ...
    public async edit(dto: DossierProjetDocumentDto) {
    ...
    public async view(dto: DossierProjetDocumentDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: DossierProjetDocumentDto) {
    ...
    public async duplicate(dto: DossierProjetDocumentDto) {
    ...
    public exportPdf(dto: DossierProjetDocumentDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            {field: 'dossierProjet?.libelle', header: 'Dossier projet'},
    ...
    public async loadDossierProjet(){
        this.dossierProjetService.findAllOptimized().subscribe(dossierProjets => this.dossierProjets = dossierProjets, error => console.log(error))
    }


	public initDuplicate(res: DossierProjetDocumentDto) {
        if (res.dossierProjetExigenceAppliques != null) {
             res.dossierProjetExigenceAppliques.forEach(d => { d.dossierProjetDocument = null; d.id = null; });
        }
	}
        ...
        this.service.findByCriteria(this.criteria).subscribe(
            (allItems) =>{
                this.exportData = allItems.map(e => {
					return {
						'Dossier projet': e.dossierProjet?.libelle ,
						'Code': e.code ,
						'Libelle': e.libelle ,
						'Path': e.path ,
						'Content': e.content ,
            ...
            this.criteriaData = [{
            //'Dossier projet': this.criteria.dossierProjet?.libelle ? this.criteria.dossierProjet?.libelle : environment.emptyForExport ,
    ...
    get selections(): Array<DossierProjetDocumentDto> {
        return this.service.selections;
    }

    set selections(value: Array<DossierProjetDocumentDto>) {
