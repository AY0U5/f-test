...
@Component({
  selector: 'app-dossier-projet-exigence-etat-list-admin',
  templateUrl: './dossier-projet-exigence-etat-list-admin.component.html'
})
export class DossierProjetExigenceEtatListAdminComponent implements OnInit {

    protected fileName = 'DossierProjetExigenceEtat';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<DossierProjetExigenceEtatDto>();
    ...
    public async edit(dto: DossierProjetExigenceEtatDto) {
    ...
    public async view(dto: DossierProjetExigenceEtatDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: DossierProjetExigenceEtatDto) {
    ...
    public async duplicate(dto: DossierProjetExigenceEtatDto) {
    ...
    public exportPdf(dto: DossierProjetExigenceEtatDto): void {
...
// add
	...
	public initDuplicate(res: DossierProjetExigenceEtatDto) {
	}
    ...
    get selections(): Array<DossierProjetExigenceEtatDto> {
        return this.service.selections;
    }

    set selections(value: Array<DossierProjetExigenceEtatDto>) {
