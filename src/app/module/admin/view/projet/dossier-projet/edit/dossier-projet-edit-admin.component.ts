...
@Component({
  selector: 'app-dossier-projet-edit-admin',
  templateUrl: './dossier-projet-edit-admin.component.html'
})
export class DossierProjetEditAdminComponent implements OnInit {
 ...
 public edit(): void {
    ...
    public validateDossierProjetExigences(){
        this.errorMessages = new Array();
    }

    public validateDossierProjetDocuments(){
        this.errorMessages = new Array();
    ...
    private validateDossierProjetDocumentsCode(){
    ...
    private validateDossierProjetDocumentsLibelle(){
