...
@Component({
  selector: 'app-dossier-projet-list-admin',
  templateUrl: './dossier-projet-list-admin.component.html'
})
export class DossierProjetListAdminComponent implements OnInit {

    protected fileName = 'DossierProjet';
    ...
    constructor( private service: DossierProjetAdminService  , private dossierProjetDocumentService: DossierProjetDocumentAdminService, private dossierProjetExigenceService: DossierProjetExigenceAdminService, private exigenceService: ExigenceAdminService, @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<DossierProjetDto>();
    ...
    public async edit(dto: DossierProjetDto) {
    ...
    public async view(dto: DossierProjetDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: DossierProjetDto) {
    ...
    public async duplicate(dto: DossierProjetDto) {
    ...
    public exportPdf(dto: DossierProjetDto): void {
...
// add
	...
	public initDuplicate(res: DossierProjetDto) {
        if (res.dossierProjetExigences != null) {
             res.dossierProjetExigences.forEach(d => { d.dossierProjet = null; d.id = null; });
        }
        if (res.dossierProjetDocuments != null) {
             res.dossierProjetDocuments.forEach(d => { d.dossierProjet = null; d.id = null; });
        }
	}
    ...
    get selections(): Array<DossierProjetDto> {
        return this.service.selections;
    }

    set selections(value: Array<DossierProjetDto>) {
